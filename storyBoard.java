...
public class storyBoard{
	public static void startScreen(){
		...
		System.out.println("\"You're not from Rehtta, are you, bud? Got a name?\" \n\n What is your name? (Cannot be changed later)");
		specialCharacter protagonist = new specialCharacter(scan.nextLine()); //created a new object called 'protagonist' to have a name and base stats
		clearScreen();
