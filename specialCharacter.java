...
public class specialCharacter {
    ...
    public boolean engage(int monster) { // passing in which mosnter we are going to fight
        ...
        boolean notLose = true; // If returned true back into storyBoard -> continue game. Otherwise, if notLose
                                // returns false -> restart game.
        boolean battle = true;
        int turn = 0;
        while (battle == true) {
            int myTotalDamage = (this.stats.get("ATK") * 6) / 5 - opponent.stats.get("DEF"); // Damage calculator (you
                                                                                             // onto enemy) —> 20%
                                                                                             // modifier on attack (this
                                                                                             // line is here for us to
                                                                                             // show total damage next
            ...
            // battle system
                ...
                if (turn % 2 == 0) {
                    ...
                    case 1:
                        turn++;
                        opponent.stats.put("currentHP", opponent.stats.get("currentHP") - myTotalDamage);// calculates
                                                                                                         // total damage
                                                                                                         // done to
                                                                                                         // enemy
                        break;
                    ...
                    case 2:
                        ...
                        int num = scan.nextInt();
                        int[] points = spell.useSpell(this, opponent, num);// passing through character, opponent, and
                                                                           // spell)
                        ...
                        System.out.println(
                                "The " + opponent.name + " Readies its Attack For " + theirTotalDamage + " Damage!");
                        System.out.println("\n\n\n\n\n");
                        System.out.println(
                                this.name + " HP: " + this.stats.get("currentHP") + "/" + this.stats.get("HP"));
                        System.out.println(
                                this.name + " MP: " + this.stats.get("currentMP") + "/" + this.stats.get("MP"));
                        try {
                    ...
                    System.out.println(
                            opponent.name + " HP: " + opponent.stats.get("currentHP") + "/" + opponent.stats.get("HP"));
                    System.out.println("\n\n\n\n\n");
